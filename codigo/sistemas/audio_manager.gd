...
const ZONE_MUSIC := {
	# ── Zonas NEXOS ───────────────────────────────────────────────────────────
	"villa_nexo":     "cinder_village",
	"ruta_1":         "route_1",
	"ciudad_nora":    "cinder_village",   # placeholder — añadir tema propio
	# ── Nombres heredados (compatibilidad) ───────────────────────────────────
	"cinder_village": "cinder_village",
	"ashgate_town":   "cinder_village",
	"route_1":        "route_1",
	"route_2":        "sea",
	"tidelock_port":  "sea",
	"overworld_sea":  "sea",
